...
public class SongBelongArtistAdapterRV extends RecyclerView.Adapter<SongBelongArtistAdapterRV.RecyclerViewHolder>  {
...
//    ArrayList<File> mySongs;
    ...
    public SongBelongArtistAdapterRV(ArrayList<Songs>listData, Context context) {
    ...
    @Override
    public SongBelongArtistAdapterRV.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(SongBelongArtistAdapterRV.RecyclerViewHolder holder, int position) {
